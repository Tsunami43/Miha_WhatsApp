...
from green_api.types.objects import *
from green_api.types.errors import *
...
class GreenApi:
    ...
    def __init__(
        ...
        self.logger = target_logger(__name__)


    def get_url(self, method: str='')-> str:
        return self.host + "/waInstance" + self.idInstance + method + "/" + self.apiTokenInstance
